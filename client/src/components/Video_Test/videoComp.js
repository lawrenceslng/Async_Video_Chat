...
//start a counter and have a recording animation during this
    ...
    btnStopRecording = (e) => {
        ...
        classThis.state.videoRecorder.stopRecording(function() {
            ...
            _xhr('https://enigmatic-plains-24739.herokuapp.com/uploadFile', file, token, function(responseText) {
                ...
                return fetch("https://enigmatic-plains-24739.herokuapp.com/uploadFile2", {
                    method: 'POST',
                    headers: {
                      'Accept': 'application/json',
