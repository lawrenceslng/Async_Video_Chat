...
<div className="row">
    ...
    <div id="thoughtArchivesNav" className="box-part text-center col-sm-3 show-archive-thoughts" onClick={props.expand}>
    ...
    <div id="activeThoughtsNav" className="box-part text-center col-sm-3 show-active-thoughts" onClick={props.expand}>
    ...
    <div id="createNewNav" className="box-part text-center show-record col-sm-3 show-record" onClick={props.expand}>
    ...
    <div id="yourCommunityNav" className="box-part text-center col-sm-3 show-friends" onClick={props.expand}>
